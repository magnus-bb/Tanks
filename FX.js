class FX {
	static showBulletTrail(trailPair) { // Trailpair couples bullet to trail, since bullet cannot house trail itself after it is destroyed
...
function shake(magnitude = Config.current.fx.defaultShakeMagnitude) {
	let shakeCount = 1;
	const numShakes = 10
	const startX = 0
	const startY = 0
